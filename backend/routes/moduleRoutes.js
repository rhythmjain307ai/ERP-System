...
function crudRouter(config, permission = 'master.write') {
  ...
  router.get('/', asyncHandler(controller.list)); router.get('/:id', asyncHandler(controller.get));
  router.post('/', requireAuth, requirePermission(permission), asyncHandler(controller.create));
  router.patch('/:id', requireAuth, requirePermission(permission), asyncHandler(controller.update));
  router.delete('/:id', requireAuth, requirePermission(permission), asyncHandler(controller.remove));
  return router;
}

...
async function createGrn(req, res) {
  ...
  }, (parent, item) => ({ grn_id: parent.grn_id, purchase_order_item_id: item.purchase_order_item_id === undefined ? undefined : id(item.purchase_order_item_id, 'purchase_order_item_id'), inventory_item_id: id(item.inventory_item_id, 'inventory_item_id'), lot_id: item.lot_id === undefined ? undefined : id(item.lot_id, 'lot_id'), heat_number: item.heat_number, uom: item.uom, challan_quantity: item.challan_quantity === undefined ? undefined : number(item.challan_quantity, 'challan_quantity'), received_quantity: number(item.received_quantity ?? item.quantity, 'received_quantity'), accepted_quantity: item.accepted_quantity === undefined ? undefined : number(item.accepted_quantity, 'accepted_quantity'), rejected_quantity: item.rejected_quantity === undefined ? undefined : number(item.rejected_quantity, 'rejected_quantity'), rejection_reason: item.rejection_reason, rate: item.rate === undefined ? undefined : number(item.rate, 'rate') }));
}
